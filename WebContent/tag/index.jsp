...
<body class="">
    ...
    -->
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					<li class="nav-item active"><a class="nav-link" href="../tag/">
			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<a class="navbar-brand">Sport ID Проверка меток</a>
					</div>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-lg-6 col-md-12">
							<div class="card">
								<div class="card-header card-header-primary">
									<h4 class="card-title">Список меток</h4>
								</div>
								<div class="card-body table-responsive">
									<button class="btn btn-primary" id="RstBttn">Сброс</button>
								</div>
							</div>
						</div>
